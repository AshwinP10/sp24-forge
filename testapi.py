...
---]"""
        ...
        prompt = f"""
Given the following extracted text from a PDF, evaluate it based on the decision tree criteria.
...
Please classify this document as 'Accepted' or 'Not Accepted' based on the decision tree criteria and provide a short summary explaining the classification.
"""
...
def upload_file():
    ...
    if file and allowed_file(file.filename):
        ...
        evaluation = evaluate_document_with_decision_tree(extracted_text)
        text_id = save_text_to_temp_file(extracted_text, evaluation)
